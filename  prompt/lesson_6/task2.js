...
if (Number(userAnswer1) === answer1) {
    alert('Ответ Верный! Песдюк ты молодец!');
    correctAnswers +=1;
} else {
    alert('Ответ неверный! внимательнее, ПОЦ!')
    incorrectAnswers += 1;
}
...
alert (`Это конец теста, ЧЕЛ! Твои результаты: Правильные ответы: ${correctAnswers} Неправильные: ${incorrectAnswers}`);